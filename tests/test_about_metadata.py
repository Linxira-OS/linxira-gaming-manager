...
REPOSITORY = "https://github.com/Linxira-OS/linxira-gaming-manager"


class AboutMetadataTests(unittest.TestCase):
    def test_about_and_metadata_urls_match(self):
        about = (ROOT / "src/linxira_gaming_manager/about.py").read_text(encoding="utf-8")
        ui = (ROOT / "src/linxira_gaming_manager/app.py").read_text(encoding="utf-8")
        ...
        component = ET.parse(ROOT / "data/org.linxira.GamingManager.metainfo.xml").getroot()
